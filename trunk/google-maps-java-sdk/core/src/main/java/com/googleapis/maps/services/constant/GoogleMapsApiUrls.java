...
public final class GoogleMapsApiUrls {
    ...
    /** The Constant LOG. */
    private static final Logger LOG = Logger.getLogger(GoogleMapsApiUrls.class.getCanonicalName());
    ...
    static {
        try {
            googleApiUrls.load(GoogleMapsApiUrls.class.getResourceAsStream(API_URLS_FILE));
        } catch (IOException e) {
